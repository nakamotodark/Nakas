...
#   c) node1 mines 32 blocks, so now node 0 has 60001nak, node 1 has 4250nak, node2 has none.
#   d) node0 sends 601 nak to node2, in two transactions (301 nak, then 300 nak).
