...
In order to support loading of multiple wallets in nakas-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is nakas.cpp.
...
Changes to nakas.cpp
----------------------
nakas.cpp is the entry point into nakas-qt, and as such, will require some minor modifications to provide hooks for
