...
* WebSocket: [https://github.com/nakasproject/insight-api-nakas#web-socket-api](https://github.com/nakasproject/insight-api-nakas#web-socket-api) 
* API: [https://github.com/nakasproject/insight-api-nakas#swifttx-transactions](https://github.com/nakasproject/insight-api-nakas#swifttx-transactions) 
...
By default, the Nakas Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Nakas Core daemon:
