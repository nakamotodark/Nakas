...
/* Nakas GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Nakas"
#define QAPP_ORG_DOMAIN "nakas.org"
#define QAPP_APP_NAME_DEFAULT "Nakas-Qt"
#define QAPP_APP_NAME_TESTNET "Nakas-Qt-testnet"
