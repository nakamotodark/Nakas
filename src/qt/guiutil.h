...
/** Utility functions used by the Nakas Qt UI.
 */
namespace GUIUtil
{
...
// Render Nakas addresses in monospace font
...
// Parse "nakas:" URI into recipient object, return true on successful parsing
