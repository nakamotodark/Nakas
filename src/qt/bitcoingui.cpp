                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Nakas Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Nakas address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and nakas: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zNAK"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Nakas Core"), this);
    aboutAction->setStatusTip(tr("Show information about Nakas Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Nakas"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Nakas addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Nakas addresses"));
    ...
    openAction->setStatusTip(tr("Open a Nakas: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Nakas Core help message to get a list with possible Nakas command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Nakas Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Nakas network", "", count));
}
...
{
    QString strTitle = tr("Nakas Core"); // default title
