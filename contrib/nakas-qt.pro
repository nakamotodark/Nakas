...
RESOURCES += src/qt/nakas.qrc src/qt/nakas_locale.qrc

TRANSLATIONS += src/qt/locale/nakas_bg.ts \
                src/qt/locale/nakas_de.ts \
                src/qt/locale/nakas_en.ts \
                src/qt/locale/nakas_es.ts \
                src/qt/locale/nakas_fi.ts \
                src/qt/locale/nakas_fr.ts \
                src/qt/locale/nakas_it.ts \
                src/qt/locale/nakas_ja.ts \
                src/qt/locale/nakas_pl.ts \
                src/qt/locale/nakas_pt.ts \
                src/qt/locale/nakas_ru.ts \
                src/qt/locale/nakas_sk.ts \
                src/qt/locale/nakas_sv.ts \
                src/qt/locale/nakas_vi.ts \
                src/qt/locale/nakas_zh_CN.ts \
                src/qt/locale/nakas_zh_TW.ts
