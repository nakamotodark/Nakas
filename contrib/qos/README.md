...
This means one can have an always-on nakasd instance running, and another local nakasd/nakas-qt instance which connects to this node and receives blocks from it.
