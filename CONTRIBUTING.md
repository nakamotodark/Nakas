Contributing to Nakas Core
============================

The Nakas Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Nakas Core project, and is not to be
confused with overall Nakas Network Protocol consensus changes.

Whether a pull request is merged into Nakas Core rests with the project merge
...
Patches that change Nakas consensus rules are considerably more involved than
...
Where a patch set proposes to change the Nakas consensus, it must have been
...
The project leader is the release manager for each Nakas Core release.
